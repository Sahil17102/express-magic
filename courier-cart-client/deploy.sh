...
export VITE_API_URL="${VITE_API_URL:-https://cheerful-fulfillment-production-07ac.up.railway.app/api}"
export VITE_APP_SOCKET_URL="${VITE_APP_SOCKET_URL:-https://cheerful-fulfillment-production-07ac.up.railway.app}"
